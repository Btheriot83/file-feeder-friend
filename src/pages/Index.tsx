  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div {...handlers} className="flex flex-col md:flex-row min-h-[calc(100vh-4rem)]">
        <aside className="w-full md:w-[30%] hidden md:block md:sticky md:top-0 md:h-screen md:overflow-y-auto">
          <Sidebar />
        </aside>
        <main className="w-full md:w-[70%] p-2 md:p-4 space-y-4 pb-20 md:pb-4 overflow-y-auto">
          <WelcomeSection />
          <CurrentLevel />
        </main>
      </div>
